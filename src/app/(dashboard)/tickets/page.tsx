...
export default async function TicketsPage() {
  ...
  // Tickets are visible company-wide within an organization — this page is
  // unreachable for Client-portal accounts (see the dashboard layout guard).
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">
          Raise an issue, question, or error to your team — visible to everyone internally, and
          tracked through to a response.
        </p>
      </div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="mt-2 text-xs text-gray-400">
                  ...
                  {ticket.createdAt.toLocaleDateString('en-IN', { dateStyle: 'medium', timeZone: 'Asia/Kolkata' })}
                </p>
              </div>
              <span
                className={clsx(
